...
tokenizer_name = 'gpt2' # default tokenizer to use
# wandb logging
...
learning_rate = 6e-4
# learning_rate = 3e-4
num_epochs = 1 # total number of training iterations
weight_decay = 1e-1
beta1 = 0.9
beta2 = 0.95
...
# Data and Tokenizer handling
data_dir = "data"


def tokenize_and_save_dataset(tokenizer, raw_text_path, output_path):
    """Tokenize raw text and save as .bin file"""
...
# Attempt to derive vocab_size from the tokenizer
meta_vocab_size = len(tokenizer.get_vocab())
print(f"Tokenizer vocabulary size: {meta_vocab_size}")
